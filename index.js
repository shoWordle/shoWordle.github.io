...
buttonArr.forEach(element => {
    element.addEventListener("click", function(){
        ...
        for(let i = 0; i < str1.length; i++){
            wordButtonsArr[i].innerHTML = `<b style="font-size: bold">${str1[i]}</b style="font-size: bold">`;
        }
        }
            ...
            for(let i = 5; i < str2.length + 5; i++){
                wordButtonsArr[i].innerHTML = `<b style="font-size: bold">${str2[i - 5]}</b style="font-size: bold">`;
            }
        }
            ...
            for(let i = 10; i < str3.length + 10; i++){
                wordButtonsArr[i].innerHTML = `<b style="font-size: bold">${str3[i - 10]}</b style="font-size: bold">`;
            }
        }
            ...
            for(let i = 15; i < str4.length + 15; i++){
                wordButtonsArr[i].innerHTML = `<b style="font-size: bold">${str4[i - 15]}</b style="font-size: bold">`;
            }
        }
            ...
            for(let i = 20; i < str5.length + 20; i++){
                wordButtonsArr[i].innerHTML = `<b style="font-size: bold">${str5[i - 20]}</b style="font-size: bold">`;
            }
        }
            ...
            for(let i = 25; i < str6.length + 25; i++){
                wordButtonsArr[i].innerHTML = `<b style="font-size: bold">${str6[i - 25]}</b style="font-size: bold">`;
            }
        }
    ...
    if(str1.length == 5 && dict.includes(str1.toLowerCase()) && true1 == false){
        ...
        for(let i = 0; i < str1.length; i++){
            ...
            if(wordArr.includes(str1[i])){
                ...
                document.getElementById(str1[i]).className = "btn btn-warning m-1";
            }
            if(wordArr[i] == str1[i]){
                console.log("Letter is present in element and in correct spot")
                wordButtonsArr[i].className = "btn btn-success m-1"
                document.getElementById(str1[i]).className = "btn btn-success m-1";
            }
    ...
    if(str2.length == 5 && dict.includes(str2.toLowerCase()) && true1 == true && true2 == false){
        ...
        for(let i = 0; i < str2.length; i++){
            ...
            if(wordArr.includes(str2[i])){
                ...
                document.getElementById(str2[i]).className = "btn btn-warning m-1";
            }
            if(wordArr[i] == str2[i]){
                console.log("Letter is present in element and in correct spot")
                wordButtonsArr[i + 5].className = "btn btn-success m-1"
                document.getElementById(str2[i]).className = "btn btn-success m-1";
            }
    ...
    if(str3.length == 5 && dict.includes(str3.toLowerCase()) && true2 == true && true3 == false){
        ...
        for(let i = 0; i < str3.length; i++){
            ...
            if(wordArr.includes(str3[i])){
                ...
                document.getElementById(str3[i]).className = "btn btn-warning m-1";
            }
            if(wordArr[i] == str3[i]){
                console.log("Letter is present in element and in correct spot")
                wordButtonsArr[i + 10].className = "btn btn-success m-1"
                document.getElementById(str3[i]).className = "btn btn-success m-1";
            }
    ...
    if(str4.length == 5 && dict.includes(str4.toLowerCase()) && true3 == true && true4 == false){
        ...
        for(let i = 0; i < str4.length; i++){
            ...
            if(wordArr.includes(str4[i])){
                ...
                document.getElementById(str4[i]).className = "btn btn-warning m-1";
            }
            if(wordArr[i] == str4[i]){
                console.log("Letter is present in element and in correct spot")
                wordButtonsArr[i + 15].className = "btn btn-success m-1"
                document.getElementById(str4[i]).className = "btn btn-success m-1";
            }
    ...
    if(str5.length == 5 && dict.includes(str5.toLowerCase()) && true4 == true && true5 == false){
        ...
        for(let i = 0; i < str5.length; i++){
            ...
            if(wordArr.includes(str5[i])){
                ...
                document.getElementById(str5[i]).className = "btn btn-warning m-1";
            }
            if(wordArr[i] == str5[i]){
                console.log("Letter is present in element and in correct spot")
                wordButtonsArr[i + 20].className = "btn btn-success m-1"
                document.getElementById(str5[i]).className = "btn btn-success m-1";
            }
    ...
    if(str6.length == 5 && dict.includes(str6.toLowerCase()) && true5 == true && true6 == false){
        ...
        for(let i = 0; i < str6.length; i++){
            ...
            if(wordArr.includes(str6[i])){
                ...
                document.getElementById(str[i]).className = "btn btn-warning m-1";
            }
            if(wordArr[i] == str6[i]){
                console.log("Letter is present in element and in correct spot")
                wordButtonsArr[i + 25].className = "btn btn-success m-1"
                document.getElementById(str6[i]).className = "btn btn-success m-1";
            }
...
back.addEventListener("click", function(){
    if(str1.length <= 5 && true1 == false){
        ...
        for(let i = 0; i <= 5; i++){    
            console.log("Please work", i)
            wordButtonsArr[i + 5].innerHTML = `<b style="font-size: bold">${str2[i]}</b style="font-size: bold">`;
        }
        for(let i = 0; i <= 5; i++){
        ...
        for(let i = 0; i <= 5; i++){    
            console.log("Please work", i)
            wordButtonsArr[i + 10].innerHTML = `<b style="font-size: bold">${str3[i]}</b style="font-size: bold">`;
        }
        for(let i = 0; i <= 5; i++){
        ...
        for(let i = 0; i <= 5; i++){    
            console.log("Please work", i)
            wordButtonsArr[i + 15].innerHTML = `<b style="font-size: bold">${str4[i]}</b style="font-size: bold">`;
        }
        for(let i = 0; i <= 5; i++){
    ...
    if(str5.length <= 5 && true4 == true && true5 == false){
        ...
        for(let i = 0; i <= 5; i++){    
            console.log("Please work", i)
            wordButtonsArr[i + 20].innerHTML = `<b style="font-size: bold">${str5[i]}</b style="font-size: bold">`;
        }
        for(let i = 0; i <= 5; i++){
    ...
    if(str6.length <= 5 && true5 == true && true6 == false){
        ...
        for(let i = 0; i <= 5; i++){    
            console.log("Please work", i)
            wordButtonsArr[i + 25].innerHTML = `<b style="font-size: bold">${str6[i]}</b style="font-size: bold">`;
        }
        for(let i = 0; i <= 5; i++){
