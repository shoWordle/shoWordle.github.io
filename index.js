...
function enterWord(string, index)
{
    ...
    if(elementString.length == 5 && dictionary.includes(elementString.toLowerCase()))
    {
        ...
        for(let i = 0; i < elementString.length; i++)
        {
            ...
            if(wordButtonsArr[i + index].className != "btn btn-success m-1")
            {
                winner = false;
            }
        }
...
function showBoard()
{
    ...
    <h4 class = "mx-2" style="color: green;">WINS: ${shoWordleArr[6]}</h4>
    <h4 class = "mx-2" style="color: red;">LOSSES: ${shoWordleArr[7]}</h4>
    </div>
    <div class="d-flex justify-content-center">
    ...
    <button type="button" class="btn btn-light">${shoWordleArr[0]}</button>
    </div>
    <div id="guess2">
        <button type="button" class="btn btn-primary">2</button>
        <button type="button" class="btn btn-light">${shoWordleArr[1]}</button>
    </div>
    <div id="guess3">
        <button type="button" class="btn btn-primary">3</button>
        <button type="button" class="btn btn-light">${shoWordleArr[2]}</button>
    </div>
    </div>
    <div class="d-flex justify-content-center my-1">
    <div id="guess4">
    <button type="button" class="btn btn-primary">4</button>
    <button type="button" class="btn btn-light">${shoWordleArr[3]}</button>
    </div>
    <div id="guess5">
        <button type="button" class="btn btn-primary">5</button>
        <button type="button" class="btn btn-light">${shoWordleArr[4]}</button>
    </div>
    <div id="guess6">
        <button type="button" class="btn btn-primary">6</button>
        <button type="button" class="btn btn-light">${shoWordleArr[5]}</button>
    </div>
    </div>
    <div class="d-flex justify-content-center">
    <button id="newGame" type="button" class="btn btn-secondary btn-sm">NEW GAME</button>
    </div>
    </div>
    `
